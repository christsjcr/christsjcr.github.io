import{S as Te,i as Pe,s as He,y as ve,z as $e,A as Ee,g as Re,d as Je,B as xe,k as a,q as h,a as p,l as r,m as l,r as f,h as t,c as m,n as b,b as o,H as d,P as Se}from"../chunks/index.5c882778.js";import{C as Ae}from"../chunks/Content.a639e13f.js";import{P as De}from"../chunks/PageHeader.47b09527.js";function qe(q){let s,c,i,u,C,F,v,g,L,I,$,N,O,E,Q,k,R,W,j,J,w,X,G,x,Y,M,T,Z,U,P,ee,V,H,y,te,z,S,ne,B,A,ie,K,D,_,oe;return{c(){s=a("h2"),c=h("📜 Constitution"),i=p(),u=a("p"),C=h(`The JCR is guided by a Constitution which dictates the composition
            ...
            to suit the changing needs of the Christ's student body.`),F=p(),v=a("h4"),g=a("a"),L=h("Download"),I=p(),$=a("h2"),N=h("📖 Standing Orders"),O=p(),E=a("p"),Q=h(`The Standing Orders are a set of extra rules and guidelines that
            ...
            if they think something isn't being done right.`),j=p(),J=a("h4"),w=a("a"),X=h("Download"),G=p(),x=a("h2"),Y=h("💸 Financial Conduct & Procedure"),M=p(),T=a("p"),Z=h(`This document specifies how the JCR handles its finances. It
            ...
            all students to read!`),V=p(),H=a("h4"),y=a("a"),te=h("Download"),z=p(),S=a("h2"),ne=h("⛹️ Society Funding Guidelines"),B=p(),A=a("p"),ie=h(`Christ's JCR funds sports clubs and non-sports clubs in accordance
            ...
            a fair overall budget.`),K=p(),D=a("h4"),_=a("a"),oe=h("Download"),this.h()},l(e){s=r(e,"H2",{});var n=l(s);c=f(n,"📜 Constitution"),n.forEach(t),i=m(e),u=r(e,"P",{});var se=l(u);C=f(se,`The JCR is guided by a Constitution which dictates the composition
            of the Executive Committee and the responsibilities of its officers
            to Christ's students. It also governs more mundane procedural
            matters and the nature of the relationship between the JCR and the
            College. Although wordy and a little dry in places, the Constitution
            ...
            students and ensures that the JCR Exec is held accountable for its
            actions. It is regularly updated and often undergoes major revisions
            to suit the changing needs of the Christ's student body.`),se.forEach(t),F=m(e),v=r(e,"H4",{});var ae=l(v);g=r(ae,"A",{href:!0,download:!0});var re=l(g);L=f(re,"Download"),re.forEach(t),ae.forEach(t),I=m(e),$=r(e,"H2",{});var le=l($);N=f(le,"📖 Standing Orders"),le.forEach(t),O=m(e),E=r(e,"P",{});var de=l(E);Q=f(de,`The Standing Orders are a set of extra rules and guidelines that
            operate alongside to the JCR Constitution. They spell out certain
            things in more detail than the Constitution - like how to conduct
            Open Meetings, Elections and Referenda - and also give specific job
